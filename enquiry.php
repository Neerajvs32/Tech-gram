...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TechGram</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Full name</b>  <input type="text" required pattern="[A-Za-z\s]+" name="fname" class="form-control"  id="fname" placeholder="Full Name"  required="">
	</p> 
