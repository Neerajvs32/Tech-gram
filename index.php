...
<?php $sql = "SELECT * from tbltourpackages limit 2";
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					...
					<h6>Eligibility Criteria : <?php echo htmlentities($result->PackageType);?></h6>
...
<div>	
					<a href="#" data-toggle="modal" data-target="#myModal4" class="view" >View More Details</a></li>
